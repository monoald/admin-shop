    ...
    <div className="relative bg-white overflow-hidden">
                  ...
                  <div className="flex items-center justify-between w-full md:w-auto">
                    <Link href="/login">
                      <div>
                        ...
                        <Image className="h-8 w-auto sm:h-10" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg" alt="Logo" width="40" height="40" layout="fixed" />
                      </div>
                    </Link>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <Image
          ...
          alt="People working decorative image"
          layout="fill"
        />
      </div>
    </div>
